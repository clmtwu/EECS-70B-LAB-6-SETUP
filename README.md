...
\
## **Step 0: Hardware**
Grab everything you need from the lab report. In this lab, we are replacing ethernet cables with type a to b usb cables, so no need for a lan cable.\
You will need 2 usb-a ports to read both the oscilloscope and the function generator
...
3. Download [NI-VISA] (https://www.ni.com/en/support/downloads/drivers/download.ni-visa.html#575764). **This is not optional** since it is the python backend required by pyvisa to communicate via usb ports
