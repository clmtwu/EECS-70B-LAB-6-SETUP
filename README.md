...
3. Download [NI-VISA](https://www.ni.com/en/support/downloads/drivers/download.ni-visa.html#575764) **not optional** since it is the python backend required by pyvisa to communicate via usb ports. pip installing "libusb" and "pyusb" for install doesn't seem to work well, so I did not bother.
